                ...
                <div class="col-lg-4 col-6 text-left">
                    <form action="{{route('search')}}" method="get">
                        <div class="input-group">
                            <input type="text" name="query" id="query" value="{{ request()->input('query')}}" class="form-control" placeholder="Search for products">
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            @foreach ($categories as $category)
                                <a href="" class="nav-item nav-link">
                                    <img src="{{ $category->icon }}" width="20">
                                    {{ $category->title }}
                                </a>
                            @endforeach
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <div class="navbar-nav ml-auto py-0 d-none d-lg-block" style="margin: 10px">
                                <a href="{{ route('cart.index') }}" class="btn px-0 ml-3">
                                    ...
                                    <span class="badge  border border-secondary rounded-circle text-primary" style="padding-bottom: 2px;" >{{ $items->count() }}</span>
                                </a>
                            </div>
                            @guest
